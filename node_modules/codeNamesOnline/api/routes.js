...
module.exports = function (app) {
	...
	app.post('/api/game/:gameCode/nextTurn', function (request, response) {
		var gameCode = request.params.gameCode;
		gameAPI.NextTurn(gameCode, function (error) {
			var result;
			if (error) {
				result = {
					success : false,
	...
	app.post('/api/game/:gameCode/resetGame', function (request, response) {
		var gameCode = request.params.gameCode;
		gameAPI.ResetGame(gameCode, function (error) {
			var result;
			if (error) {
				result = {
					success : false,
